...
def build_gate_plan(root: Path, python: Path, output: Path, profile: str) -> list[GateStage]:
    ...
    stages = [
        ...
        _stage(
            ...
            root,
            python,
            stage_root / "09-dependency-audit",
            (
                (
                    py,
                    ...
                    "--strict",
                    "--evidence-dir",
                    str(stage_root / "09-dependency-audit" / "evidence"),
                ),
            ),
        ...
        stages.extend(
            [
                ...
                _stage(
                    ...
                    root,
                    python,
                    stage_root / "22-rag-mcp",
                    _rag_commands(root, python, stage_root / "22-rag-mcp"),
